...
class FlaxTransformer3DModel(nn.Module):
    r"""
    ...
    def setup(self):
        ...
        self.norm = nn.GroupNorm(num_groups=self.norm_num_groups, group_size=self.in_channels, eps=1e-6, affine=True)
    ...
    def __call__(self, hidden_states, encoder_hidden_states=None, timestep=None, return_dict: bool = True, deterministic=True):
        # Input
